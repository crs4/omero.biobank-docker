...
IceImport.load("omero_model_IlluminaBeadChipArray_ice")
from omero.rtypes import rlong
_omero = Ice.openModule("omero")
_omero_model = Ice.openModule("omero.model")
__name__ = "omero.model"
class IlluminaBeadChipArrayI(_omero_model.IlluminaBeadChipArray):

      ASSAYTYPE =  "ome.model.vl.IlluminaBeadChipArray_assayType"
      LABEL =  "ome.model.vl.IlluminaBeadChipArray_label"
      SLOT =  "ome.model.vl.IlluminaBeadChipArray_slot"
      CONTAINER =  "ome.model.vl.IlluminaBeadChipArray_container"
      CONTAINERSLOTLABELUK =  "ome.model.vl.IlluminaBeadChipArray_containerSlotLabelUK"
      CONTAINERSLOTINDEXUK =  "ome.model.vl.IlluminaBeadChipArray_containerSlotIndexUK"
      VID =  "ome.model.vl.IlluminaBeadChipArray_vid"
      ACTIVATIONDATE =  "ome.model.vl.IlluminaBeadChipArray_activationDate"
      DESTRUCTIONDATE =  "ome.model.vl.IlluminaBeadChipArray_destructionDate"
      CURRENTVOLUME =  "ome.model.vl.IlluminaBeadChipArray_currentVolume"
      INITIALVOLUME =  "ome.model.vl.IlluminaBeadChipArray_initialVolume"
      CONTENT =  "ome.model.vl.IlluminaBeadChipArray_content"
      STATUS =  "ome.model.vl.IlluminaBeadChipArray_status"
      ACTION =  "ome.model.vl.IlluminaBeadChipArray_action"
      LASTUPDATE =  "ome.model.vl.IlluminaBeadChipArray_lastUpdate"
      DETAILS =  "ome.model.vl.IlluminaBeadChipArray_details"
      ...
      def __init__(self, id = None, loaded = True):
          super(IlluminaBeadChipArrayI, self).__init__()
      ...
      def proxy(self, current = None):
          ...
          return IlluminaBeadChipArrayI( self._id.getValue(), False )
...
_omero_model.IlluminaBeadChipArrayI = IlluminaBeadChipArrayI
