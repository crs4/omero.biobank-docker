...
IceImport.load("omero_model_AffymetrixArray_ice")
from omero.rtypes import rlong
_omero = Ice.openModule("omero")
_omero_model = Ice.openModule("omero.model")
__name__ = "omero.model"
class AffymetrixArrayI(_omero_model.AffymetrixArray):

      ASSAYTYPE =  "ome.model.vl.AffymetrixArray_assayType"
      LABEL =  "ome.model.vl.AffymetrixArray_label"
      BARCODE =  "ome.model.vl.AffymetrixArray_barcode"
      VID =  "ome.model.vl.AffymetrixArray_vid"
      ACTIVATIONDATE =  "ome.model.vl.AffymetrixArray_activationDate"
      DESTRUCTIONDATE =  "ome.model.vl.AffymetrixArray_destructionDate"
      CURRENTVOLUME =  "ome.model.vl.AffymetrixArray_currentVolume"
      INITIALVOLUME =  "ome.model.vl.AffymetrixArray_initialVolume"
      CONTENT =  "ome.model.vl.AffymetrixArray_content"
      STATUS =  "ome.model.vl.AffymetrixArray_status"
      ACTION =  "ome.model.vl.AffymetrixArray_action"
      LASTUPDATE =  "ome.model.vl.AffymetrixArray_lastUpdate"
      DETAILS =  "ome.model.vl.AffymetrixArray_details"
      ...
      def __init__(self, id = None, loaded = True):
          super(AffymetrixArrayI, self).__init__()
      ...
      def proxy(self, current = None):
          ...
          return AffymetrixArrayI( self._id.getValue(), False )
...
_omero_model.AffymetrixArrayI = AffymetrixArrayI
