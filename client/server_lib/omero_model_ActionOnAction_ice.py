...
# <auto-generated>
#
# Generated from file `ActionOnAction.ice'
#
...
if not _M_omero.model.__dict__.has_key('ActionOnAction'):
    ...
    _M_omero.model.ActionOnActionPrx = Ice.createTempClass()
    class ActionOnActionPrx(_M_omero.model.ActionPrx):

        def getTarget(self, _ctx=None):
            return _M_omero.model.ActionOnAction._op_getTarget.invoke(self, ((), _ctx))

        def begin_getTarget(self, _response=None, _ex=None, _sent=None, _ctx=None):
            return _M_omero.model.ActionOnAction._op_getTarget.begin(self, ((), _response, _ex, _sent, _ctx))

        def end_getTarget(self, _r):
            return _M_omero.model.ActionOnAction._op_getTarget.end(self, _r)

        def setTarget(self, theTarget, _ctx=None):
            return _M_omero.model.ActionOnAction._op_setTarget.invoke(self, ((theTarget, ), _ctx))
