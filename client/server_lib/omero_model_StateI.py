...
IceImport.load("omero_model_State_ice")
from omero.rtypes import rlong
_omero = Ice.openModule("omero")
_omero_model = Ice.openModule("omero.model")
__name__ = "omero.model"
class StateI(_omero_model.State):

      LANDREGISTERCODE =  "ome.model.vl.State_landRegisterCode"
      VID =  "ome.model.vl.State_vid"
      NAME =  "ome.model.vl.State_name"
      ISTATCODE =  "ome.model.vl.State_istatCode"
      LASTUPDATE =  "ome.model.vl.State_lastUpdate"
      CEASEDATE =  "ome.model.vl.State_ceaseDate"
      DETAILS =  "ome.model.vl.State_details"
      ...
      def proxy(self, current = None):
          ...
          return StateI( self._id.getValue(), False )
