...
if not _M_omero.api.__dict__.has_key('MetadataStore'):
    ...
    class MetadataStore(_M_omero.api.StatefulServiceInterface):
        ...
        def saveToDB_async(self, _cb, current=None):
            pass
    ...
    class MetadataStorePrx(_M_omero.api.StatefulServiceInterfacePrx):
        ...
        def saveToDB(self, _ctx=None):
            return _M_omero.api.MetadataStore._op_saveToDB.invoke(self, ((), _ctx))

        def begin_saveToDB(self, _response=None, _ex=None, _sent=None, _ctx=None):
            return _M_omero.api.MetadataStore._op_saveToDB.begin(self, ((), _response, _ex, _sent, _ctx))

        def end_saveToDB(self, _r):
            return _M_omero.api.MetadataStore._op_saveToDB.end(self, _r)

        def saveToDB_async(self, _cb, _ctx=None):
            return _M_omero.api.MetadataStore._op_saveToDB.invokeAsync(self, (_cb, (), _ctx))
    ...
    MetadataStore._op_saveToDB = IcePy.Operation('saveToDB', Ice.OperationMode.Normal, Ice.OperationMode.Normal, True, (), (), (), _M_omero.api._t_PixelsList, (_M_omero._t_ServerError,))
