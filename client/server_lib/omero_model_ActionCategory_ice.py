...
# <auto-generated>
#
# Generated from file `ActionCategory.ice'
#
...
_M_omero.model.enums.ActionCategoryIMPORT = "IMPORT"

_M_omero.model.enums.ActionCategoryCREATION = "CREATION"
...
if not _M_omero.model.__dict__.has_key('ActionCategory'):
    ...
    class ActionCategory(_M_omero.model.IObject):
        ...
        def __str__(self):
            return IcePy.stringify(self, _M_omero.model._t_ActionCategory)

        __repr__ = __str__

    _M_omero.model.ActionCategoryPrx = Ice.createTempClass()
    class ActionCategoryPrx(_M_omero.model.IObjectPrx):

        def getValue(self, _ctx=None):
            return _M_omero.model.ActionCategory._op_getValue.invoke(self, ((), _ctx))

        def begin_getValue(self, _response=None, _ex=None, _sent=None, _ctx=None):
            return _M_omero.model.ActionCategory._op_getValue.begin(self, ((), _response, _ex, _sent, _ctx))

        def end_getValue(self, _r):
            return _M_omero.model.ActionCategory._op_getValue.end(self, _r)

        def setValue(self, theValue, _ctx=None):
            return _M_omero.model.ActionCategory._op_setValue.invoke(self, ((theValue, ), _ctx))
