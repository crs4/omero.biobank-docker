...
--
-- GENERATED Fri Oct 24 09:27:55 2014 from /home/omero/ome/dist/sql/psql/OMERO4.4__0
--
...
BEGIN;
    ...
    create table actiononaction (
        action_id int8 not null,
        target int8 not null,
        primary key (action_id)
    );;

    create table actiononcollection (
        action_id int8 not null,
        target int8 not null,
        primary key (action_id)
    );;

    create table actionondatacollectionitem (
        action_id int8 not null,
        target int8 not null,
        primary key (action_id)
    );;

    create table actionondatasample (
        action_id int8 not null,
        target int8 not null,
        primary key (action_id)
    );;

    create table actiononindividual (
        action_id int8 not null,
        target int8 not null,
        primary key (action_id)
    );;

    create table actiononvessel (
        action_id int8 not null,
        target int8 not null,
        primary key (action_id)
    );;

    create table actionsetup (
        id int8 not null,
        conf text not null,
        permissions int8 not null,
    ...
    create table affymetrixarray (
        tube_id int8 not null,
        assayType int8 not null,
        primary key (tube_id)
    );;

    create table affymetrixassaytype (
        id int8 not null,
        permissions int8 not null,
        value varchar(255) not null unique,
        external_id int8 unique,
    ...
    create table affymetrixcel (
        celID varchar(255) unique,
        microarraymeasure_id int8 not null,
        arrayType int8 not null,
        primary key (microarraymeasure_id)
    );;

    create table affymetrixcelarraytype (
        id int8 not null,
        permissions int8 not null,
        value varchar(255) not null unique,
        external_id int8 unique,
    ...
    create table agreement (
        ...
        owner_id int8 not null,
        update_id int8 not null,
        enrollment int8 not null,
        refConsent int8 not null,
        primary key (id)
    );;

    create table alignedseqdatasample (
        seqdatasample_id int8 not null,
        referenceGenome int8 not null,
        primary key (seqdatasample_id)
    );;

    create table annotatedchip (
        chip_id int8 not null,
        annotationFile int8 not null unique,
        primary key (chip_id)
    );;
    ...
    create table city (
        districtLabel varchar(255),
        landRegisterCode varchar(255),
        uslCode varchar(255),
        zipCode varchar(255),
    ...
    create table container (
        barcode varchar(255) unique,
        vlcollection_id int8 not null,
        status int8 not null,
        primary key (vlcollection_id)
    );;
    ...
    create table datacollectionitem (
        id int8 not null,
        dataCollectionItemUK varchar(255) not null unique,
        permissions int8 not null,
        version int4,
        vid varchar(255) not null unique,
        dataCollection int8 not null,
        dataSample int8 not null,
        creation_id int8 not null,
        external_id int8 unique,
        group_id int8 not null,
        owner_id int8 not null,
    ...
    create table dataobject (
        originalfile_id int8 not null,
        sample int8 not null,
        primary key (originalfile_id)
    );;
    ...
    create table demographic (
        ...
        deathDate timestamp,
        demogUK varchar(255) not null unique,
        permissions int8 not null,
        email varchar(255),
        livingAddress varchar(255),
        name varchar(255) not null,
        nationalIDCode varchar(255) unique,
        phone1 varchar(255),
        phone2 varchar(255),
        ...
        individual int8 not null unique,
        lastUpdate int8,
        livingPlace int8,
        primary key (id)
    );;
    ...
    create table enrollment (
        id int8 not null,
        permissions int8 not null,
        stCodeUK varchar(255) not null unique,
        stIndUK varchar(255) not null unique,
    ...
    create table flowcell (
        slottedcontainer_id int8 not null,
        primary key (slottedcontainer_id)
    );;
    ...
    create table geneexpressionlevelsdatasample (
        datasample_id int8 not null,
        primary key (datasample_id)
    );;

    create table genomevariationsdatasample (
        datasample_id int8 not null,
        referenceGenome int8 not null,
        primary key (datasample_id)
    );;

    create table genomicassemblydatasample (
        seqdatasample_id int8 not null,
        primary key (seqdatasample_id)
    );;

    create table genotypedatasample (
        datasample_id int8 not null,
        snpMarkersSet int8 not null,
        primary key (datasample_id)
    );;

    create table genotypingprogram (
        softwareprogram_id int8 not null,
        snpMarkersSet int8 not null,
        primary key (softwareprogram_id)
    );;
    ...
    create table illuminaarrayofarrays (
        titerplate_id int8 not null,
        arrayClass int8 not null,
        assayType int8 not null,
        type int8 not null,
        primary key (titerplate_id)
    );;

    create table illuminaarrayofarraysassaytype (
        id int8 not null,
        permissions int8 not null,
        value varchar(255) not null unique,
        external_id int8 unique,
    ...
    create table illuminaarrayofarraysclass (
        id int8 not null,
        permissions int8 not null,
        value varchar(255) not null unique,
        external_id int8 unique,
    ...
    create table illuminaarrayofarraystype (
        id int8 not null,
        permissions int8 not null,
        value varchar(255) not null unique,
        external_id int8 unique,
    ...
    create table illuminabeadchiparray (
        platewell_id int8 not null,
        assayType int8 not null,
        primary key (platewell_id)
    );;

    create table illuminabeadchipassaytype (
        id int8 not null,
        permissions int8 not null,
        value varchar(255) not null unique,
        external_id int8 unique,
    ...
    create table illuminabeadchipmeasure (
        microarraymeasure_id int8 not null,
        primary key (microarraymeasure_id)
    );;

    create table illuminabeadchipmeasures (
        datacollection_id int8 not null,
        greenChannel int8 not null,
        redChannel int8 not null,
    ...
    create table informedconsent (
        ...
        approvingCommission varchar(255),
        authors varchar(255),
        description varchar(255),
        permissions int8 not null,
        documentHash varchar(255) unique,
        documentPath varchar(255) unique,
        label varchar(255) not null unique,
        version int4,
        vid varchar(255) not null unique,
        answersData int8 unique,
        creation_id int8 not null,
        external_id int8 unique,
        group_id int8 not null,
        owner_id int8 not null,
        update_id int8 not null,
        refStudy int8 not null,
        primary key (id)
    );;
    ...
    create table lane (
        laneUK varchar(255) not null unique,
        slot int4 not null,
        container_id int8 not null,
        flowCell int8 not null,
        primary key (container_id)
    );;

    create table laneslot (
        id int8 not null,
        permissions int8 not null,
        laneSlotUK varchar(255) not null unique,
        tag varchar(255),
        version int4,
    ...
    create table location (
        ...
        ceaseDate timestamp,
        permissions int8 not null,
        istatCode varchar(255) not null unique,
    ...
    create table microarraymeasure (
        datasample_id int8 not null,
        primary key (datasample_id)
    );;
    ...
    create table platewell (
        containerSlotIndexUK varchar(255) not null unique,
        containerSlotLabelUK varchar(255) not null unique,
        label varchar(255) not null,
        slot int4 not null,
        vessel_id int8 not null,
        container int8 not null,
    ...
    create table referencegenome (
        nChroms int4 not null,
        maker varchar(255) not null,
        model varchar(255) not null,
        referenceGenomeUK varchar(255) not null unique,
        release varchar(255) not null,
        datasample_id int8 not null,
        primary key (datasample_id)
    );;
    ...
    create table scanner (
        hardwaredevice_id int8 not null,
        primary key (hardwaredevice_id)
    );;
    ...
    create table seqdatasample (
        datasample_id int8 not null,
        sample int8,
        primary key (datasample_id)
    );;

    create table sequenceroutput (
        datasample_id int8 not null,
        primary key (datasample_id)
    );;
    ...
    create table slottedcontainer (
        numberOfSlots int4 not null,
        container_id int8 not null,
        primary key (container_id)
    );;

    create table snpmarkersset (
        id int8 not null,
        permissions int8 not null,
        label varchar(255) not null unique,
        maker varchar(255) not null,
        markersSetVID varchar(255) not null unique,
        model varchar(255) not null,
        release varchar(255) not null,
        snpMarkersSetUK varchar(255) not null unique,
        version int4,
        creation_id int8 not null,
        external_id int8 unique,
        group_id int8 not null,
    ...
    create table taggeddatacollectionitem (
        role varchar(255) not null,
        datacollectionitem_id int8 not null,
        primary key (datacollectionitem_id)
    );;

    create table taxonomicprofiledatasample (
        datasample_id int8 not null,
        primary key (datasample_id)
    );;
    ...
    create table titerplate (
        columns int4 not null,
        "rows" int4 not null,
        slottedcontainer_id int8 not null,
        primary key (slottedcontainer_id)
    );;
    ...
    create table variantcallsupport (
        datasample_id int8 not null,
        referenceGenome int8 not null,
        primary key (datasample_id)
    );;
    ...
    create table vessel (
        ...
        currentVolume double precision not null not null,
        destructionDate timestamp,
        permissions int8 not null,
        initialVolume double precision not null not null,
        version int4,
        vid varchar(255) not null unique,
        action int8 not null,
        content int8 not null,
    ...
    create table vesselscollection (
        vlcollection_id int8 not null,
        primary key (vlcollection_id)
    );;

    create table vesselscollectionitem (
        id int8 not null,
        permissions int8 not null,
        version int4,
        vesselsCollectionItemUK varchar(255) not null unique,
        vid varchar(255) not null unique,
        creation_id int8 not null,
        external_id int8 unique,
        group_id int8 not null,
        owner_id int8 not null,
        update_id int8 not null,
        vessel int8 not null,
        vesselsCollection int8 not null,
        primary key (id)
    );;
    ...
    alter table action 
        add constraint FKaction_creation_id_event 
        foreign key (creation_id) 
        references event  ;;

    alter table action 
        add constraint FKaction_update_id_event 
        foreign key (update_id) 
        references event  ;;

    alter table action 
        add constraint FKaction_external_id_externalinfo 
        foreign key (external_id) 
        references externalinfo  ;;

    alter table action 
        add constraint FKaction_setup_actionsetup 
        foreign key (setup) 
        references actionsetup  ;;

    alter table action 
        add constraint FKaction_device_device 
        foreign key (device) 
        references device  ;;

    alter table action 
        add constraint FKaction_group_id_experimentergroup 
        foreign key (group_id) 
        references experimentergroup  ;;

    alter table action 
        add constraint FKaction_actionCategory_actioncategory 
        foreign key (actionCategory) 
        references actioncategory  ;;

    alter table action 
        add constraint FKaction_owner_id_experimenter 
        foreign key (owner_id) 
        references experimenter  ;;

    alter table action 
        add constraint FKaction_context_study 
        foreign key (context) 
        references study  ;;

    alter table actioncategory 
        add constraint FKactioncategory_external_id_externalinfo 
        foreign key (external_id) 
        references externalinfo  ;;

    alter table actiononaction 
        add constraint FKactiononaction_action_id_action 
        foreign key (action_id) 
        references action  ;;

    alter table actiononaction 
        add constraint FKactiononaction_target_action 
        foreign key (target) 
        references action  ;;

    alter table actiononcollection 
        add constraint FKactiononcollection_action_id_action 
        foreign key (action_id) 
        references action  ;;

    alter table actiononcollection 
        add constraint FKactiononcollection_target_vlcollection 
        foreign key (target) 
        references vlcollection  ;;

    alter table actionondatacollectionitem 
        add constraint FKactionondatacollectionitem_action_id_action 
        foreign key (action_id) 
        references action  ;;

    alter table actionondatacollectionitem 
        add constraint FKactionondatacollectionitem_target_datacollectionitem 
        foreign key (target) 
        references datacollectionitem  ;;

    alter table actionondatasample 
        add constraint FKactionondatasample_action_id_action 
        foreign key (action_id) 
        references action  ;;

    alter table actionondatasample 
        add constraint FKactionondatasample_target_datasample 
        foreign key (target) 
        references datasample  ;;

    alter table actiononindividual 
        add constraint FKactiononindividual_action_id_action 
        foreign key (action_id) 
        references action  ;;

    alter table actiononindividual 
        add constraint FKactiononindividual_target_individual 
        foreign key (target) 
        references individual  ;;

    alter table actiononvessel 
        add constraint FKactiononvessel_action_id_action 
        foreign key (action_id) 
        references action  ;;

    alter table actiononvessel 
        add constraint FKactiononvessel_target_vessel 
        foreign key (target) 
        references vessel  ;;

    alter table actionsetup 
        add constraint FKactionsetup_creation_id_event 
        foreign key (creation_id) 
        references event  ;;

    alter table actionsetup 
        add constraint FKactionsetup_update_id_event 
        foreign key (update_id) 
        references event  ;;

    alter table actionsetup 
        add constraint FKactionsetup_external_id_externalinfo 
        foreign key (external_id) 
        references externalinfo  ;;

    alter table actionsetup 
        add constraint FKactionsetup_group_id_experimentergroup 
        foreign key (group_id) 
        references experimentergroup  ;;

    alter table actionsetup 
        add constraint FKactionsetup_owner_id_experimenter 
        foreign key (owner_id) 
        references experimenter  ;;

    alter table affymetrixarray 
        add constraint FKaffymetrixarray_tube_id_tube 
        foreign key (tube_id) 
        references tube  ;;

    alter table affymetrixarray 
        add constraint FKaffymetrixarray_assayType_affymetrixassaytype 
        foreign key (assayType) 
        references affymetrixassaytype  ;;

    alter table affymetrixassaytype 
        add constraint FKaffymetrixassaytype_external_id_externalinfo 
        foreign key (external_id) 
        references externalinfo  ;;

    alter table affymetrixcel 
        add constraint FKaffymetrixcel_arrayType_affymetrixcelarraytype 
        foreign key (arrayType) 
        references affymetrixcelarraytype  ;;

    alter table affymetrixcel 
        add constraint FKaffymetrixcel_microarraymeasure_id_microarraymeasure 
        foreign key (microarraymeasure_id) 
        references microarraymeasure  ;;

    alter table affymetrixcelarraytype 
        add constraint FKaffymetrixcelarraytype_external_id_externalinfo 
        foreign key (external_id) 
        references externalinfo  ;;

    alter table agreement 
        add constraint FKagreement_creation_id_event 
        foreign key (creation_id) 
        references event  ;;

    alter table agreement 
        add constraint FKagreement_update_id_event 
        foreign key (update_id) 
        references event  ;;

    alter table agreement 
        add constraint FKagreement_external_id_externalinfo 
        foreign key (external_id) 
        references externalinfo  ;;

    alter table agreement 
        add constraint FKagreement_enrollment_enrollment 
        foreign key (enrollment) 
        references enrollment  ;;

    alter table agreement 
        add constraint FKagreement_group_id_experimentergroup 
        foreign key (group_id) 
        references experimentergroup  ;;

    alter table agreement 
        add constraint FKagreement_refConsent_informedconsent 
        foreign key (refConsent) 
        references informedconsent  ;;

    alter table agreement 
        add constraint FKagreement_owner_id_experimenter 
        foreign key (owner_id) 
        references experimenter  ;;

    alter table alignedseqdatasample 
        add constraint FKalignedseqdatasample_referenceGenome_referencegenome 
        foreign key (referenceGenome) 
        references referencegenome  ;;

    alter table alignedseqdatasample 
        add constraint FKalignedseqdatasample_seqdatasample_id_seqdatasample 
        foreign key (seqdatasample_id) 
        references seqdatasample  ;;

    alter table annotatedchip 
        add constraint FKannotatedchip_annotationFile_originalfile 
        foreign key (annotationFile) 
        references originalfile  ;;

    alter table annotatedchip 
        add constraint FKannotatedchip_chip_id_chip 
        foreign key (chip_id) 
        references chip  ;;
    ...
    alter table chip 
        add constraint FKchip_device_id_device 
        foreign key (device_id) 
        references device  ;;

    alter table city 
        add constraint FKcity_location_id_location 
        foreign key (location_id) 
        references location  ;;

    alter table city 
        add constraint FKcity_region_region 
        foreign key (region) 
        references region  ;;
    ...
    alter table container 
        add constraint FKcontainer_status_containerstatus 
        foreign key (status) 
        references containerstatus  ;;

    alter table container 
        add constraint FKcontainer_vlcollection_id_vlcollection 
        foreign key (vlcollection_id) 
        references vlcollection  ;;

    alter table containerstatus 
        add constraint FKcontainerstatus_external_id_externalinfo 
        foreign key (external_id) 
        references externalinfo  ;;
    ...
    alter table datacollection 
        add constraint FKdatacollection_vlcollection_id_vlcollection 
        foreign key (vlcollection_id) 
        references vlcollection  ;;

    alter table datacollectionitem 
        add constraint FKdatacollectionitem_creation_id_event 
        foreign key (creation_id) 
        references event  ;;

    alter table datacollectionitem 
        add constraint FKdatacollectionitem_update_id_event 
        foreign key (update_id) 
        references event  ;;

    alter table datacollectionitem 
        add constraint FKdatacollectionitem_external_id_externalinfo 
        foreign key (external_id) 
        references externalinfo  ;;

    alter table datacollectionitem 
        add constraint FKdatacollectionitem_dataSample_datasample 
        foreign key (dataSample) 
        references datasample  ;;

    alter table datacollectionitem 
        add constraint FKdatacollectionitem_group_id_experimentergroup 
        foreign key (group_id) 
        references experimentergroup  ;;

    alter table datacollectionitem 
        add constraint FKdatacollectionitem_dataCollection_datacollection 
        foreign key (dataCollection) 
        references datacollection  ;;

    alter table datacollectionitem 
        add constraint FKdatacollectionitem_owner_id_experimenter 
        foreign key (owner_id) 
        references experimenter  ;;

    alter table dataobject 
        add constraint FKdataobject_originalfile_id_originalfile 
        foreign key (originalfile_id) 
        references originalfile  ;;

    alter table dataobject 
        add constraint FKdataobject_sample_datasample 
        foreign key (sample) 
        references datasample  ;;

    alter table datasample 
        add constraint FKdatasample_creation_id_event 
        foreign key (creation_id) 
        references event  ;;

    alter table datasample 
        add constraint FKdatasample_update_id_event 
        foreign key (update_id) 
        references event  ;;

    alter table datasample 
        add constraint FKdatasample_external_id_externalinfo 
        foreign key (external_id) 
        references externalinfo  ;;

    alter table datasample 
        add constraint FKdatasample_status_datasamplestatus 
        foreign key (status) 
        references datasamplestatus  ;;

    alter table datasample 
        add constraint FKdatasample_group_id_experimentergroup 
        foreign key (group_id) 
        references experimentergroup  ;;

    alter table datasample 
        add constraint FKdatasample_owner_id_experimenter 
        foreign key (owner_id) 
        references experimenter  ;;

    alter table datasample 
        add constraint FKdatasample_action_action 
        foreign key (action) 
        references action  ;;

    alter table datasamplestatus 
        add constraint FKdatasamplestatus_external_id_externalinfo 
        foreign key (external_id) 
        references externalinfo  ;;
    ...
    alter table demographic 
        add constraint FKdemographic_creation_id_event 
        foreign key (creation_id) 
        references event  ;;

    alter table demographic 
        add constraint FKdemographic_lastUpdate_actiononaction 
        foreign key (lastUpdate) 
        references actiononaction  ;;

    alter table demographic 
        add constraint FKdemographic_update_id_event 
        foreign key (update_id) 
        references event  ;;

    alter table demographic 
        add constraint FKdemographic_external_id_externalinfo 
        foreign key (external_id) 
        references externalinfo  ;;

    alter table demographic 
        add constraint FKdemographic_birthPlace_location 
        foreign key (birthPlace) 
        references location  ;;

    alter table demographic 
        add constraint FKdemographic_individual_individual 
        foreign key (individual) 
        references individual  ;;

    alter table demographic 
        add constraint FKdemographic_group_id_experimentergroup 
        foreign key (group_id) 
        references experimentergroup  ;;

    alter table demographic 
        add constraint FKdemographic_gender_gender 
        foreign key (gender) 
        references gender  ;;

    alter table demographic 
        add constraint FKdemographic_owner_id_experimenter 
        foreign key (owner_id) 
        references experimenter  ;;

    alter table demographic 
        add constraint FKdemographic_action_action 
        foreign key (action) 
        references action  ;;

    alter table demographic 
        add constraint FKdemographic_livingPlace_location 
        foreign key (livingPlace) 
        references location  ;;
    ...
    alter table device 
        add constraint FKdevice_creation_id_event 
        foreign key (creation_id) 
        references event  ;;

    alter table device 
        add constraint FKdevice_update_id_event 
        foreign key (update_id) 
        references event  ;;

    alter table device 
        add constraint FKdevice_external_id_externalinfo 
        foreign key (external_id) 
        references externalinfo  ;;

    alter table device 
        add constraint FKdevice_group_id_experimentergroup 
        foreign key (group_id) 
        references experimentergroup  ;;

    alter table device 
        add constraint FKdevice_owner_id_experimenter 
        foreign key (owner_id) 
        references experimenter  ;;
    ...
    alter table enrollment 
        add constraint FKenrollment_creation_id_event 
        foreign key (creation_id) 
        references event  ;;

    alter table enrollment 
        add constraint FKenrollment_update_id_event 
        foreign key (update_id) 
        references event  ;;

    alter table enrollment 
        add constraint FKenrollment_external_id_externalinfo 
        foreign key (external_id) 
        references externalinfo  ;;

    alter table enrollment 
        add constraint FKenrollment_individual_individual 
        foreign key (individual) 
        references individual  ;;

    alter table enrollment 
        add constraint FKenrollment_study_study 
        foreign key (study) 
        references study  ;;

    alter table enrollment 
        add constraint FKenrollment_group_id_experimentergroup 
        foreign key (group_id) 
        references experimentergroup  ;;

    alter table enrollment 
        add constraint FKenrollment_owner_id_experimenter 
        foreign key (owner_id) 
        references experimenter  ;;
    ...
    alter table flowcell 
        add constraint FKflowcell_slottedcontainer_id_slottedcontainer 
        foreign key (slottedcontainer_id) 
        references slottedcontainer  ;;
    ...
    alter table gender 
        add constraint FKgender_external_id_externalinfo 
        foreign key (external_id) 
        references externalinfo  ;;

    alter table geneexpressionlevelsdatasample 
        add constraint FKgeneexpressionlevelsdatasample_datasample_id_datasample 
        foreign key (datasample_id) 
        references datasample  ;;

    alter table genomevariationsdatasample 
        add constraint FKgenomevariationsdatasample_referenceGenome_referencegenome 
        foreign key (referenceGenome) 
        references referencegenome  ;;

    alter table genomevariationsdatasample 
        add constraint FKgenomevariationsdatasample_datasample_id_datasample 
        foreign key (datasample_id) 
        references datasample  ;;

    alter table genomicassemblydatasample 
        add constraint FKgenomicassemblydatasample_seqdatasample_id_seqdatasample 
        foreign key (seqdatasample_id) 
        references seqdatasample  ;;

    alter table genotypedatasample 
        add constraint FKgenotypedatasample_datasample_id_datasample 
        foreign key (datasample_id) 
        references datasample  ;;

    alter table genotypedatasample 
        add constraint FKgenotypedatasample_snpMarkersSet_snpmarkersset 
        foreign key (snpMarkersSet) 
        references snpmarkersset  ;;

    alter table genotypingprogram 
        add constraint FKgenotypingprogram_softwareprogram_id_softwareprogram 
        foreign key (softwareprogram_id) 
        references softwareprogram  ;;

    alter table genotypingprogram 
        add constraint FKgenotypingprogram_snpMarkersSet_snpmarkersset 
        foreign key (snpMarkersSet) 
        references snpmarkersset  ;;
    ...
    alter table hardwaredevice 
        add constraint FKhardwaredevice_device_id_device 
        foreign key (device_id) 
        references device  ;;

    alter table illuminaarrayofarrays 
        add constraint FKilluminaarrayofarrays_type_illuminaarrayofarraystype 
        foreign key (type) 
        references illuminaarrayofarraystype  ;;

    alter table illuminaarrayofarrays 
        add constraint FKilluminaarrayofarrays_titerplate_id_titerplate 
        foreign key (titerplate_id) 
        references titerplate  ;;

    alter table illuminaarrayofarrays 
        add constraint FKilluminaarrayofarrays_arrayClass_illuminaarrayofarraysclass 
        foreign key (arrayClass) 
        references illuminaarrayofarraysclass  ;;

    alter table illuminaarrayofarrays 
        add constraint FKilluminaarrayofarrays_assayType_illuminaarrayofarraysassaytype 
        foreign key (assayType) 
        references illuminaarrayofarraysassaytype  ;;

    alter table illuminaarrayofarraysassaytype 
        add constraint FKilluminaarrayofarraysassaytype_external_id_externalinfo 
        foreign key (external_id) 
        references externalinfo  ;;

    alter table illuminaarrayofarraysclass 
        add constraint FKilluminaarrayofarraysclass_external_id_externalinfo 
        foreign key (external_id) 
        references externalinfo  ;;

    alter table illuminaarrayofarraystype 
        add constraint FKilluminaarrayofarraystype_external_id_externalinfo 
        foreign key (external_id) 
        references externalinfo  ;;

    alter table illuminabeadchiparray 
        add constraint FKilluminabeadchiparray_platewell_id_platewell 
        foreign key (platewell_id) 
        references platewell  ;;

    alter table illuminabeadchiparray 
        add constraint FKilluminabeadchiparray_assayType_illuminabeadchipassaytype 
        foreign key (assayType) 
        references illuminabeadchipassaytype  ;;

    alter table illuminabeadchipassaytype 
        add constraint FKilluminabeadchipassaytype_external_id_externalinfo 
        foreign key (external_id) 
        references externalinfo  ;;

    alter table illuminabeadchipmeasure 
        add constraint FKilluminabeadchipmeasure_microarraymeasure_id_microarraymeasure 
        foreign key (microarraymeasure_id) 
        references microarraymeasure  ;;

    alter table illuminabeadchipmeasures 
        add constraint FKilluminabeadchipmeasures_greenChannel_illuminabeadchipmeasure 
        foreign key (greenChannel) 
        references illuminabeadchipmeasure  ;;

    alter table illuminabeadchipmeasures 
        add constraint FKilluminabeadchipmeasures_redChannel_illuminabeadchipmeasure 
        foreign key (redChannel) 
        references illuminabeadchipmeasure  ;;

    alter table illuminabeadchipmeasures 
        add constraint FKilluminabeadchipmeasures_datacollection_id_datacollection 
        foreign key (datacollection_id) 
        references datacollection  ;;
    ...
    alter table individual 
        add constraint FKindividual_creation_id_event 
        foreign key (creation_id) 
        references event  ;;

    alter table individual 
        add constraint FKindividual_lastUpdate_actiononaction 
        foreign key (lastUpdate) 
        references actiononaction  ;;

    alter table individual 
        add constraint FKindividual_update_id_event 
        foreign key (update_id) 
        references event  ;;

    alter table individual 
        add constraint FKindividual_external_id_externalinfo 
        foreign key (external_id) 
        references externalinfo  ;;

    alter table individual 
        add constraint FKindividual_mother_individual 
        foreign key (mother) 
        references individual  ;;

    alter table individual 
        add constraint FKindividual_group_id_experimentergroup 
        foreign key (group_id) 
        references experimentergroup  ;;

    alter table individual 
        add constraint FKindividual_gender_gender 
        foreign key (gender) 
        references gender  ;;

    alter table individual 
        add constraint FKindividual_father_individual 
        foreign key (father) 
        references individual  ;;

    alter table individual 
        add constraint FKindividual_owner_id_experimenter 
        foreign key (owner_id) 
        references experimenter  ;;

    alter table individual 
        add constraint FKindividual_action_action 
        foreign key (action) 
        references action  ;;

    alter table informedconsent 
        add constraint FKinformedconsent_creation_id_event 
        foreign key (creation_id) 
        references event  ;;

    alter table informedconsent 
        add constraint FKinformedconsent_update_id_event 
        foreign key (update_id) 
        references event  ;;

    alter table informedconsent 
        add constraint FKinformedconsent_external_id_externalinfo 
        foreign key (external_id) 
        references externalinfo  ;;

    alter table informedconsent 
        add constraint FKinformedconsent_answersData_originalfile 
        foreign key (answersData) 
        references originalfile  ;;

    alter table informedconsent 
        add constraint FKinformedconsent_refStudy_study 
        foreign key (refStudy) 
        references study  ;;

    alter table informedconsent 
        add constraint FKinformedconsent_group_id_experimentergroup 
        foreign key (group_id) 
        references experimentergroup  ;;

    alter table informedconsent 
        add constraint FKinformedconsent_owner_id_experimenter 
        foreign key (owner_id) 
        references experimenter  ;;
    ...
    alter table lane 
        add constraint FKlane_flowCell_flowcell 
        foreign key (flowCell) 
        references flowcell  ;;

    alter table lane 
        add constraint FKlane_container_id_container 
        foreign key (container_id) 
        references container  ;;

    alter table laneslot 
        add constraint FKlaneslot_creation_id_event 
        foreign key (creation_id) 
        references event  ;;

    alter table laneslot 
        add constraint FKlaneslot_lastUpdate_action 
        foreign key (lastUpdate) 
        references action  ;;

    alter table laneslot 
        add constraint FKlaneslot_update_id_event 
        foreign key (update_id) 
        references event  ;;

    alter table laneslot 
        add constraint FKlaneslot_external_id_externalinfo 
        foreign key (external_id) 
        references externalinfo  ;;

    alter table laneslot 
        add constraint FKlaneslot_lane_lane 
        foreign key (lane) 
        references lane  ;;

    alter table laneslot 
        add constraint FKlaneslot_group_id_experimentergroup 
        foreign key (group_id) 
        references experimentergroup  ;;

    alter table laneslot 
        add constraint FKlaneslot_owner_id_experimenter 
        foreign key (owner_id) 
        references experimenter  ;;

    alter table laneslot 
        add constraint FKlaneslot_action_action 
        foreign key (action) 
        references action  ;;

    alter table laneslot 
        add constraint FKlaneslot_content_vesselcontent 
        foreign key (content) 
        references vesselcontent  ;;
    ...
    alter table location 
        add constraint FKlocation_creation_id_event 
        foreign key (creation_id) 
        references event  ;;

    alter table location 
        add constraint FKlocation_update_id_event 
        foreign key (update_id) 
        references event  ;;

    alter table location 
        add constraint FKlocation_external_id_externalinfo 
        foreign key (external_id) 
        references externalinfo  ;;

    alter table location 
        add constraint FKlocation_group_id_experimentergroup 
        foreign key (group_id) 
        references experimentergroup  ;;

    alter table location 
        add constraint FKlocation_owner_id_experimenter 
        foreign key (owner_id) 
        references experimenter  ;;
    ...
    alter table microarraymeasure 
        add constraint FKmicroarraymeasure_datasample_id_datasample 
        foreign key (datasample_id) 
        references datasample  ;;
    ...
    alter table platewell 
        add constraint FKplatewell_vessel_id_vessel 
        foreign key (vessel_id) 
        references vessel  ;;

    alter table platewell 
        add constraint FKplatewell_container_titerplate 
    ...
    alter table rawseqdatasample 
        add constraint FKrawseqdatasample_lane_lane 
        foreign key (lane) 
        references lane  ;;

    alter table rawseqdatasample 
        add constraint FKrawseqdatasample_datasample_id_datasample 
        foreign key (datasample_id) 
        references datasample  ;;
    ...
    alter table referencegenome 
        add constraint FKreferencegenome_datasample_id_datasample 
        foreign key (datasample_id) 
        references datasample  ;;

    alter table region 
        add constraint FKregion_location_id_location 
        foreign key (location_id) 
        references location  ;;
    ...
    alter table scanner 
        add constraint FKscanner_hardwaredevice_id_hardwaredevice 
        foreign key (hardwaredevice_id) 
        references hardwaredevice  ;;
    ...
    alter table seqdatasample 
        add constraint FKseqdatasample_datasample_id_datasample 
        foreign key (datasample_id) 
        references datasample  ;;

    alter table seqdatasample 
        add constraint FKseqdatasample_sample_tube 
        foreign key (sample) 
        references tube  ;;

    alter table sequenceroutput 
        add constraint FKsequenceroutput_datasample_id_datasample 
        foreign key (datasample_id) 
        references datasample  ;;
    ...
    alter table slottedcontainer 
        add constraint FKslottedcontainer_container_id_container 
        foreign key (container_id) 
        references container  ;;

    alter table snpmarkersset 
        add constraint FKsnpmarkersset_creation_id_event 
        foreign key (creation_id) 
        references event  ;;

    alter table snpmarkersset 
        add constraint FKsnpmarkersset_update_id_event 
        foreign key (update_id) 
        references event  ;;

    alter table snpmarkersset 
        add constraint FKsnpmarkersset_external_id_externalinfo 
        foreign key (external_id) 
        references externalinfo  ;;

    alter table snpmarkersset 
        add constraint FKsnpmarkersset_group_id_experimentergroup 
        foreign key (group_id) 
        references experimentergroup  ;;

    alter table snpmarkersset 
        add constraint FKsnpmarkersset_owner_id_experimenter 
        foreign key (owner_id) 
        references experimenter  ;;

    alter table softwareprogram 
        add constraint FKsoftwareprogram_device_id_device 
        foreign key (device_id) 
        references device  ;;
    ...
    alter table state 
        add constraint FKstate_location_id_location 
        foreign key (location_id) 
        references location  ;;
    ...
    alter table study 
        add constraint FKstudy_creation_id_event 
        foreign key (creation_id) 
        references event  ;;

    alter table study 
        add constraint FKstudy_update_id_event 
        foreign key (update_id) 
        references event  ;;

    alter table study 
        add constraint FKstudy_external_id_externalinfo 
        foreign key (external_id) 
        references externalinfo  ;;

    alter table study 
        add constraint FKstudy_group_id_experimentergroup 
        foreign key (group_id) 
        references experimentergroup  ;;

    alter table study 
        add constraint FKstudy_owner_id_experimenter 
        foreign key (owner_id) 
        references experimenter  ;;

    alter table taggeddatacollectionitem 
        add constraint FKtaggeddatacollectionitem_datacollectionitem_id_datacollectionitem 
        foreign key (datacollectionitem_id) 
        references datacollectionitem  ;;

    alter table taxonomicprofiledatasample 
        add constraint FKtaxonomicprofiledatasample_datasample_id_datasample 
        foreign key (datasample_id) 
        references datasample  ;;
    ...
    alter table titerplate 
        add constraint FKtiterplate_slottedcontainer_id_slottedcontainer 
        foreign key (slottedcontainer_id) 
        references slottedcontainer  ;;
    ...
    alter table tube 
        add constraint FKtube_vessel_id_vessel 
        foreign key (vessel_id) 
        references vessel  ;;

    alter table variantcallsupport 
        add constraint FKvariantcallsupport_referenceGenome_referencegenome 
        foreign key (referenceGenome) 
        references referencegenome  ;;

    alter table variantcallsupport 
        add constraint FKvariantcallsupport_datasample_id_datasample 
        foreign key (datasample_id) 
        references datasample  ;;

    alter table vessel 
        add constraint FKvessel_creation_id_event 
        foreign key (creation_id) 
        references event  ;;

    alter table vessel 
        add constraint FKvessel_lastUpdate_action 
        foreign key (lastUpdate) 
        references action  ;;

    alter table vessel 
        add constraint FKvessel_update_id_event 
        foreign key (update_id) 
        references event  ;;

    alter table vessel 
        add constraint FKvessel_external_id_externalinfo 
        foreign key (external_id) 
        references externalinfo  ;;

    alter table vessel 
        add constraint FKvessel_status_vesselstatus 
        foreign key (status) 
        references vesselstatus  ;;

    alter table vessel 
        add constraint FKvessel_group_id_experimentergroup 
        foreign key (group_id) 
        references experimentergroup  ;;

    alter table vessel 
        add constraint FKvessel_owner_id_experimenter 
        foreign key (owner_id) 
        references experimenter  ;;

    alter table vessel 
        add constraint FKvessel_action_action 
        foreign key (action) 
        references action  ;;

    alter table vessel 
        add constraint FKvessel_content_vesselcontent 
        foreign key (content) 
        references vesselcontent  ;;

    alter table vesselcontent 
        add constraint FKvesselcontent_external_id_externalinfo 
        foreign key (external_id) 
        references externalinfo  ;;

    alter table vesselscollection 
        add constraint FKvesselscollection_vlcollection_id_vlcollection 
        foreign key (vlcollection_id) 
        references vlcollection  ;;

    alter table vesselscollectionitem 
        add constraint FKvesselscollectionitem_creation_id_event 
        foreign key (creation_id) 
        references event  ;;

    alter table vesselscollectionitem 
        add constraint FKvesselscollectionitem_update_id_event 
        foreign key (update_id) 
        references event  ;;

    alter table vesselscollectionitem 
        add constraint FKvesselscollectionitem_external_id_externalinfo 
        foreign key (external_id) 
        references externalinfo  ;;

    alter table vesselscollectionitem 
        add constraint FKvesselscollectionitem_vessel_vessel 
        foreign key (vessel) 
        references vessel  ;;

    alter table vesselscollectionitem 
        add constraint FKvesselscollectionitem_group_id_experimentergroup 
        foreign key (group_id) 
        references experimentergroup  ;;

    alter table vesselscollectionitem 
        add constraint FKvesselscollectionitem_vesselsCollection_vesselscollection 
        foreign key (vesselsCollection) 
        references vesselscollection  ;;

    alter table vesselscollectionitem 
        add constraint FKvesselscollectionitem_owner_id_experimenter 
        foreign key (owner_id) 
        references experimenter  ;;

    alter table vesselstatus 
        add constraint FKvesselstatus_external_id_externalinfo 
        foreign key (external_id) 
        references externalinfo  ;;

    alter table vlcollection 
        add constraint FKvlcollection_creation_id_event 
        foreign key (creation_id) 
        references event  ;;

    alter table vlcollection 
        add constraint FKvlcollection_lastUpdate_action 
        foreign key (lastUpdate) 
        references action  ;;

    alter table vlcollection 
        add constraint FKvlcollection_update_id_event 
        foreign key (update_id) 
        references event  ;;

    alter table vlcollection 
        add constraint FKvlcollection_external_id_externalinfo 
        foreign key (external_id) 
        references externalinfo  ;;

    alter table vlcollection 
        add constraint FKvlcollection_group_id_experimentergroup 
        foreign key (group_id) 
        references experimentergroup  ;;

    alter table vlcollection 
        add constraint FKvlcollection_owner_id_experimenter 
        foreign key (owner_id) 
        references experimenter  ;;

    alter table vlcollection 
        add constraint FKvlcollection_action_action 
        foreign key (action) 
        references action  ;;
...
-- Indexes
--
  CREATE INDEX i_action_owner ON action(owner_id);
  CREATE INDEX i_action_group ON action(group_id);
  CREATE INDEX i_Action_setup ON action(setup);
  CREATE INDEX i_Action_device ON action(device);
  CREATE INDEX i_Action_actionCategory ON action(actionCategory);
  CREATE INDEX i_Action_context ON action(context);
  CREATE INDEX i_ActionOnAction_target ON actiononaction(target);
  CREATE INDEX i_ActionOnCollection_target ON actiononcollection(target);
  CREATE INDEX i_ActionOnDataCollectionItem_target ON actionondatacollectionitem(target);
  CREATE INDEX i_ActionOnDataSample_target ON actionondatasample(target);
  CREATE INDEX i_ActionOnIndividual_target ON actiononindividual(target);
  CREATE INDEX i_ActionOnVessel_target ON actiononvessel(target);
  CREATE INDEX i_actionsetup_owner ON actionsetup(owner_id);
  CREATE INDEX i_actionsetup_group ON actionsetup(group_id);
  CREATE INDEX i_AffymetrixArray_assayType ON affymetrixarray(assayType);
  CREATE INDEX i_AffymetrixCel_arrayType ON affymetrixcel(arrayType);
  CREATE INDEX i_agreement_owner ON agreement(owner_id);
  CREATE INDEX i_agreement_group ON agreement(group_id);
  CREATE INDEX i_Agreement_refConsent ON agreement(refConsent);
  CREATE INDEX i_Agreement_enrollment ON agreement(enrollment);
  CREATE INDEX i_AlignedSeqDataSample_referenceGenome ON alignedseqdatasample(referenceGenome);
  CREATE INDEX i_AnnotatedChip_annotationFile ON annotatedchip(annotationFile);
  ...
  CREATE INDEX i_City_region ON city(region);
  ...
  CREATE INDEX i_Container_status ON container(status);
  CREATE INDEX i_datacollectionitem_owner ON datacollectionitem(owner_id);
  CREATE INDEX i_datacollectionitem_group ON datacollectionitem(group_id);
  CREATE INDEX i_DataCollectionItem_dataSample ON datacollectionitem(dataSample);
  CREATE INDEX i_DataCollectionItem_dataCollection ON datacollectionitem(dataCollection);
  CREATE INDEX i_DataObject_sample ON dataobject(sample);
  CREATE INDEX i_datasample_owner ON datasample(owner_id);
  CREATE INDEX i_datasample_group ON datasample(group_id);
  CREATE INDEX i_DataSample_status ON datasample(status);
  CREATE INDEX i_DataSample_action ON datasample(action);
  ...
  CREATE INDEX i_demographic_owner ON demographic(owner_id);
  CREATE INDEX i_demographic_group ON demographic(group_id);
  CREATE INDEX i_Demographic_birthPlace ON demographic(birthPlace);
  CREATE INDEX i_Demographic_livingPlace ON demographic(livingPlace);
  CREATE INDEX i_Demographic_gender ON demographic(gender);
  CREATE INDEX i_Demographic_individual ON demographic(individual);
  CREATE INDEX i_Demographic_action ON demographic(action);
  CREATE INDEX i_Demographic_lastUpdate ON demographic(lastUpdate);
  ...
  CREATE INDEX i_device_owner ON device(owner_id);
  CREATE INDEX i_device_group ON device(group_id);
  ...
  CREATE INDEX i_enrollment_owner ON enrollment(owner_id);
  CREATE INDEX i_enrollment_group ON enrollment(group_id);
  CREATE INDEX i_Enrollment_individual ON enrollment(individual);
  CREATE INDEX i_Enrollment_study ON enrollment(study);
  ...
  CREATE INDEX i_GenomeVariationsDataSample_referenceGenome ON genomevariationsdatasample(referenceGenome);
  CREATE INDEX i_GenotypeDataSample_snpMarkersSet ON genotypedatasample(snpMarkersSet);
  CREATE INDEX i_GenotypingProgram_snpMarkersSet ON genotypingprogram(snpMarkersSet);
  ...
  CREATE INDEX i_IlluminaArrayOfArrays_type ON illuminaarrayofarrays(type);
  CREATE INDEX i_IlluminaArrayOfArrays_arrayClass ON illuminaarrayofarrays(arrayClass);
  CREATE INDEX i_IlluminaArrayOfArrays_assayType ON illuminaarrayofarrays(assayType);
  CREATE INDEX i_IlluminaBeadChipArray_assayType ON illuminabeadchiparray(assayType);
  CREATE INDEX i_IlluminaBeadChipMeasures_redChannel ON illuminabeadchipmeasures(redChannel);
  CREATE INDEX i_IlluminaBeadChipMeasures_greenChannel ON illuminabeadchipmeasures(greenChannel);
  ...
  CREATE INDEX i_individual_owner ON individual(owner_id);
  CREATE INDEX i_individual_group ON individual(group_id);
  CREATE INDEX i_Individual_gender ON individual(gender);
  CREATE INDEX i_Individual_father ON individual(father);
  CREATE INDEX i_Individual_mother ON individual(mother);
  CREATE INDEX i_Individual_action ON individual(action);
  CREATE INDEX i_Individual_lastUpdate ON individual(lastUpdate);
  CREATE INDEX i_informedconsent_owner ON informedconsent(owner_id);
  CREATE INDEX i_informedconsent_group ON informedconsent(group_id);
  CREATE INDEX i_InformedConsent_answersData ON informedconsent(answersData);
  CREATE INDEX i_InformedConsent_refStudy ON informedconsent(refStudy);
  ...
  CREATE INDEX i_Lane_flowCell ON lane(flowCell);
  CREATE INDEX i_laneslot_owner ON laneslot(owner_id);
  CREATE INDEX i_laneslot_group ON laneslot(group_id);
  CREATE INDEX i_LaneSlot_lane ON laneslot(lane);
  CREATE INDEX i_LaneSlot_content ON laneslot(content);
  CREATE INDEX i_LaneSlot_action ON laneslot(action);
  CREATE INDEX i_LaneSlot_lastUpdate ON laneslot(lastUpdate);
  ...
  CREATE INDEX i_location_owner ON location(owner_id);
  CREATE INDEX i_location_group ON location(group_id);
  ...
  CREATE INDEX i_PlateWell_container ON platewell(container);
  ...
  CREATE INDEX i_RawSeqDataSample_lane ON rawseqdatasample(lane);
  ...
  CREATE INDEX i_snpmarkersset_owner ON snpmarkersset(owner_id);
  CREATE INDEX i_snpmarkersset_group ON snpmarkersset(group_id);
  ...
  CREATE INDEX i_SeqDataSample_sample ON seqdatasample(sample);
  ...
  CREATE INDEX i_study_owner ON study(owner_id);
  CREATE INDEX i_study_group ON study(group_id);
  ...
  CREATE INDEX i_vlcollection_owner ON vlcollection(owner_id);
  CREATE INDEX i_vlcollection_group ON vlcollection(group_id);
  CREATE INDEX i_VLCollection_action ON vlcollection(action);
  CREATE INDEX i_VLCollection_lastUpdate ON vlcollection(lastUpdate);
  CREATE INDEX i_VariantCallSupport_referenceGenome ON variantcallsupport(referenceGenome);
  CREATE INDEX i_vessel_owner ON vessel(owner_id);
  CREATE INDEX i_vessel_group ON vessel(group_id);
  CREATE INDEX i_Vessel_content ON vessel(content);
  CREATE INDEX i_Vessel_status ON vessel(status);
  CREATE INDEX i_Vessel_action ON vessel(action);
  CREATE INDEX i_Vessel_lastUpdate ON vessel(lastUpdate);
  CREATE INDEX i_vesselscollectionitem_owner ON vesselscollectionitem(owner_id);
  CREATE INDEX i_vesselscollectionitem_group ON vesselscollectionitem(group_id);
  CREATE INDEX i_VesselsCollectionItem_vessel ON vesselscollectionitem(vessel);
  CREATE INDEX i_VesselsCollectionItem_vesselsCollection ON vesselscollectionitem(vesselsCollection);
...
CREATE SEQUENCE seq_action; INSERT INTO _lock_ids (name, id) SELECT 'seq_action', nextval('_lock_seq');
CREATE SEQUENCE seq_actioncategory; INSERT INTO _lock_ids (name, id) SELECT 'seq_actioncategory', nextval('_lock_seq');
CREATE SEQUENCE seq_actionsetup; INSERT INTO _lock_ids (name, id) SELECT 'seq_actionsetup', nextval('_lock_seq');
CREATE SEQUENCE seq_affymetrixassaytype; INSERT INTO _lock_ids (name, id) SELECT 'seq_affymetrixassaytype', nextval('_lock_seq');
CREATE SEQUENCE seq_affymetrixcelarraytype; INSERT INTO _lock_ids (name, id) SELECT 'seq_affymetrixcelarraytype', nextval('_lock_seq');
CREATE SEQUENCE seq_agreement; INSERT INTO _lock_ids (name, id) SELECT 'seq_agreement', nextval('_lock_seq');
...
CREATE SEQUENCE seq_containerstatus; INSERT INTO _lock_ids (name, id) SELECT 'seq_containerstatus', nextval('_lock_seq');
...
CREATE SEQUENCE seq_datacollectionitem; INSERT INTO _lock_ids (name, id) SELECT 'seq_datacollectionitem', nextval('_lock_seq');
CREATE SEQUENCE seq_datasample; INSERT INTO _lock_ids (name, id) SELECT 'seq_datasample', nextval('_lock_seq');
CREATE SEQUENCE seq_datasamplestatus; INSERT INTO _lock_ids (name, id) SELECT 'seq_datasamplestatus', nextval('_lock_seq');
...
CREATE SEQUENCE seq_demographic; INSERT INTO _lock_ids (name, id) SELECT 'seq_demographic', nextval('_lock_seq');
...
CREATE SEQUENCE seq_device; INSERT INTO _lock_ids (name, id) SELECT 'seq_device', nextval('_lock_seq');
...
CREATE SEQUENCE seq_enrollment; INSERT INTO _lock_ids (name, id) SELECT 'seq_enrollment', nextval('_lock_seq');
...
CREATE SEQUENCE seq_gender; INSERT INTO _lock_ids (name, id) SELECT 'seq_gender', nextval('_lock_seq');
CREATE SEQUENCE seq_groupexperimentermap; INSERT INTO _lock_ids (name, id) SELECT 'seq_groupexperimentermap', nextval('_lock_seq');
CREATE SEQUENCE seq_illuminaarrayofarraysassaytype; INSERT INTO _lock_ids (name, id) SELECT 'seq_illuminaarrayofarraysassaytype', nextval('_lock_seq');
CREATE SEQUENCE seq_illuminaarrayofarraysclass; INSERT INTO _lock_ids (name, id) SELECT 'seq_illuminaarrayofarraysclass', nextval('_lock_seq');
CREATE SEQUENCE seq_illuminaarrayofarraystype; INSERT INTO _lock_ids (name, id) SELECT 'seq_illuminaarrayofarraystype', nextval('_lock_seq');
CREATE SEQUENCE seq_illuminabeadchipassaytype; INSERT INTO _lock_ids (name, id) SELECT 'seq_illuminabeadchipassaytype', nextval('_lock_seq');
...
CREATE SEQUENCE seq_individual; INSERT INTO _lock_ids (name, id) SELECT 'seq_individual', nextval('_lock_seq');
CREATE SEQUENCE seq_informedconsent; INSERT INTO _lock_ids (name, id) SELECT 'seq_informedconsent', nextval('_lock_seq');
...
CREATE SEQUENCE seq_laneslot; INSERT INTO _lock_ids (name, id) SELECT 'seq_laneslot', nextval('_lock_seq');
...
CREATE SEQUENCE seq_location; INSERT INTO _lock_ids (name, id) SELECT 'seq_location', nextval('_lock_seq');
...
CREATE SEQUENCE seq_snpmarkersset; INSERT INTO _lock_ids (name, id) SELECT 'seq_snpmarkersset', nextval('_lock_seq');
...
CREATE SEQUENCE seq_study; INSERT INTO _lock_ids (name, id) SELECT 'seq_study', nextval('_lock_seq');
...
CREATE SEQUENCE seq_vlcollection; INSERT INTO _lock_ids (name, id) SELECT 'seq_vlcollection', nextval('_lock_seq');
CREATE SEQUENCE seq_vessel; INSERT INTO _lock_ids (name, id) SELECT 'seq_vessel', nextval('_lock_seq');
CREATE SEQUENCE seq_vesselcontent; INSERT INTO _lock_ids (name, id) SELECT 'seq_vesselcontent', nextval('_lock_seq');
CREATE SEQUENCE seq_vesselstatus; INSERT INTO _lock_ids (name, id) SELECT 'seq_vesselstatus', nextval('_lock_seq');
CREATE SEQUENCE seq_vesselscollectionitem; INSERT INTO _lock_ids (name, id) SELECT 'seq_vesselscollectionitem', nextval('_lock_seq');
...
insert into actioncategory (id,permissions,value)
    select ome_nextval('seq_actioncategory'),-52,'IMPORT';
insert into actioncategory (id,permissions,value)
    select ome_nextval('seq_actioncategory'),-52,'CREATION';
insert into actioncategory (id,permissions,value)
    select ome_nextval('seq_actioncategory'),-52,'EXTRACTION';
insert into actioncategory (id,permissions,value)
    select ome_nextval('seq_actioncategory'),-52,'UPDATE';
insert into actioncategory (id,permissions,value)
    select ome_nextval('seq_actioncategory'),-52,'ALIQUOTING';
insert into actioncategory (id,permissions,value)
    select ome_nextval('seq_actioncategory'),-52,'MEASUREMENT';
insert into actioncategory (id,permissions,value)
    select ome_nextval('seq_actioncategory'),-52,'PROCESSING';
insert into affymetrixassaytype (id,permissions,value)
    select ome_nextval('seq_affymetrixassaytype'),-52,'UNKNOWN';
insert into affymetrixassaytype (id,permissions,value)
    select ome_nextval('seq_affymetrixassaytype'),-52,'GENOMEWIDESNP_6';
insert into affymetrixcelarraytype (id,permissions,value)
    select ome_nextval('seq_affymetrixcelarraytype'),-52,'UNKNOWN';
insert into affymetrixcelarraytype (id,permissions,value)
    select ome_nextval('seq_affymetrixcelarraytype'),-52,'GENOMEWIDESNP_6';
...
insert into containerstatus (id,permissions,value)
    select ome_nextval('seq_containerstatus'),-52,'INSTOCK';
insert into containerstatus (id,permissions,value)
    select ome_nextval('seq_containerstatus'),-52,'UNUSABLE';
insert into containerstatus (id,permissions,value)
    select ome_nextval('seq_containerstatus'),-52,'UNKNOWN';
insert into containerstatus (id,permissions,value)
    select ome_nextval('seq_containerstatus'),-52,'INPREPARATION';
insert into containerstatus (id,permissions,value)
    select ome_nextval('seq_containerstatus'),-52,'READY';
insert into containerstatus (id,permissions,value)
    select ome_nextval('seq_containerstatus'),-52,'USED';
insert into containerstatus (id,permissions,value)
    select ome_nextval('seq_containerstatus'),-52,'DISCARDED';
...
insert into datasamplestatus (id,permissions,value)
    select ome_nextval('seq_datasamplestatus'),-52,'UNKNOWN';
insert into datasamplestatus (id,permissions,value)
    select ome_nextval('seq_datasamplestatus'),-52,'DESTROYED';
insert into datasamplestatus (id,permissions,value)
    select ome_nextval('seq_datasamplestatus'),-52,'CORRUPTED';
insert into datasamplestatus (id,permissions,value)
    select ome_nextval('seq_datasamplestatus'),-52,'USABLE';
...
insert into gender (id,permissions,value)
    select ome_nextval('seq_gender'),-52,'MALE';
insert into gender (id,permissions,value)
    select ome_nextval('seq_gender'),-52,'FEMALE';
insert into illuminaarrayofarraysassaytype (id,permissions,value)
    select ome_nextval('seq_illuminaarrayofarraysassaytype'),-52,'Infinium_HD';
insert into illuminaarrayofarraysassaytype (id,permissions,value)
    select ome_nextval('seq_illuminaarrayofarraysassaytype'),-52,'UNKNOWN';
insert into illuminaarrayofarraysassaytype (id,permissions,value)
    select ome_nextval('seq_illuminaarrayofarraysassaytype'),-52,'Infinium_NXT';
insert into illuminaarrayofarraysclass (id,permissions,value)
    select ome_nextval('seq_illuminaarrayofarraysclass'),-52,'Slide';
insert into illuminaarrayofarraysclass (id,permissions,value)
    select ome_nextval('seq_illuminaarrayofarraysclass'),-52,'UNKNOWN';
insert into illuminaarrayofarraystype (id,permissions,value)
    select ome_nextval('seq_illuminaarrayofarraystype'),-52,'BeadChip_12x1Q';
insert into illuminaarrayofarraystype (id,permissions,value)
    select ome_nextval('seq_illuminaarrayofarraystype'),-52,'UNKNOWN';
insert into illuminaarrayofarraystype (id,permissions,value)
    select ome_nextval('seq_illuminaarrayofarraystype'),-52,'BeadChip_12x8';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'UNKNOWN';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'HUMAN1M_DUO';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'HUMANOMNI5_QUAD';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'HUMANOMNI2_5S';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'HUMANOMNI2_5_8';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'HUMANOMNI1S';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'HUMANOMNI1_QUAD';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'HUMANOMNIEXPRESS';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'HUMANCYTOSNP_12';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'METABOCHIP';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'IMMUNOCHIP';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'ALS_ISELECT_272541_A';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'CVDSNP55V1_A';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'CARDIO_METABO_CHIP_11395247_A';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'HUMAN1M';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'HUMAN1M_2';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'HUMAN1M_DUOV3_B';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'HUMAN610_QUADV1_B';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'HUMAN660W_QUAD_V1_A';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'HUMANCNV370_QUADV3_C';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'HUMANCNV370V1';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'HUMANEXOME_12V1_A';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'HUMANHAP250SV1_0';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'HUMANHAP300V1_1';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'HUMANHAP300V2_0';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'HUMANHAP550V1_1';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'HUMANHAP550V3_0';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'HUMANHAP650YV1_0';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'HUMANHAP650YV3_0';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'HUMANOMNI1_QUAD_V1_0_B';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'HUMANOMNI1_QUAD_V1_0_C';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'HUMANOMNI2_5_4V1_B';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'HUMANOMNI2_5_4V1_D';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'HUMANOMNI2_5_4V1_H';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'HUMANOMNI25EXOME_8V1_A';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'HUMANOMNI5_4V1_B';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'HUMANOMNIEXPRESSEXOME_8V1_A';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'HUMANOMNIEXPRESS_12V1_C';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'HUMANOMNIEXPRESS_12V1_MULTI_H';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'IMMUNO_BEADCHIP_11419691_B';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'LINKAGE_12';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'HUMANEXOME_12V1_B';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'HUMANEXOME_12V1_1_A';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'HUMANEXOME_12V1_2_A';
insert into illuminabeadchipassaytype (id,permissions,value)
    select ome_nextval('seq_illuminabeadchipassaytype'),-52,'HUMANOMNIEXPRESS_24V1_0_A';
...
insert into vesselcontent (id,permissions,value)
    select ome_nextval('seq_vesselcontent'),-52,'EMPTY';
insert into vesselcontent (id,permissions,value)
    select ome_nextval('seq_vesselcontent'),-52,'BLOOD';
insert into vesselcontent (id,permissions,value)
    select ome_nextval('seq_vesselcontent'),-52,'SERUM';
insert into vesselcontent (id,permissions,value)
    select ome_nextval('seq_vesselcontent'),-52,'DNA';
insert into vesselcontent (id,permissions,value)
    select ome_nextval('seq_vesselcontent'),-52,'RNA';
insert into vesselstatus (id,permissions,value)
    select ome_nextval('seq_vesselstatus'),-52,'UNUSED';
insert into vesselstatus (id,permissions,value)
    select ome_nextval('seq_vesselstatus'),-52,'UNKNOWN';
insert into vesselstatus (id,permissions,value)
    select ome_nextval('seq_vesselstatus'),-52,'UNUSABLE';
insert into vesselstatus (id,permissions,value)
    select ome_nextval('seq_vesselstatus'),-52,'DISCARDED';
insert into vesselstatus (id,permissions,value)
    select ome_nextval('seq_vesselstatus'),-52,'CONTENTUSABLE';
insert into vesselstatus (id,permissions,value)
    select ome_nextval('seq_vesselstatus'),-52,'CONTENTCORRUPTED';
